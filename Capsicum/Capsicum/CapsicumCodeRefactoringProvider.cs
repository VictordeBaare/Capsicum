...
namespace Capsicum
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(CapsicumCodeRefactoringProvider)), Shared]
    internal class CapsicumCodeRefactoringProvider : CodeRefactoringProvider
    {
